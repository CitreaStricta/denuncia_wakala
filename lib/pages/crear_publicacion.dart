...
class _CrearPublicacionState extends State<CrearPublicacion> {
  ...
  Future<http.Response> crearPublicacion(String sector, String descripcion,
      String base64Foto1, String base64Foto2) async {
                ...
                children: [
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        setState(() {
                          _futureMensaje = crearPublicacion(
